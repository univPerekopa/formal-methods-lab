...
// Command-line arguments: run --no-verify /Users/mp/cpp_sandbox/dafny-lab/main.dfy
// main.dfy
...
namespace _module {
  ...
  public partial class Postomat {
    public Postomat() {
      this.cells = Dafny.Map<BigInteger, bool>.Empty;
      this.codes = Dafny.Map<BigInteger, BigInteger>.Empty;
      this.payments = Dafny.Map<BigInteger, BigInteger>.Empty;
    }
    public Dafny.IMap<BigInteger,bool> cells {get; set;}
    public Dafny.IMap<BigInteger,BigInteger> codes {get; set;}
    public Dafny.IMap<BigInteger,BigInteger> payments {get; set;}
    public void __ctor()
    {
      (this).cells = Dafny.Map<BigInteger, bool>.FromElements();
      (this).codes = Dafny.Map<BigInteger, BigInteger>.FromElements();
      (this).payments = Dafny.Map<BigInteger, BigInteger>.FromElements();
    }
    public void AddParcel(BigInteger parcelId, BigInteger cellId, BigInteger code, BigInteger amount)
    {
      (this).cells = Dafny.Map<BigInteger, bool>.Update(this.cells, cellId, true);
      (this).codes = Dafny.Map<BigInteger, BigInteger>.Update(this.codes, parcelId, code);
      (this).payments = Dafny.Map<BigInteger, BigInteger>.Update(this.payments, parcelId, amount);
      ...
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" прийнята в комірку ")).ToVerbatimString(false));
      Dafny.Helpers.Print((cellId));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
    public bool PayForParcel(BigInteger parcelId, BigInteger balance)
    {
      bool paid = false;
      if ((Dafny.Map<BigInteger, BigInteger>.Select(this.payments,parcelId)).Sign == 0) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Оплата вже була проведена")).ToVerbatimString(false));
        paid = true;
        return paid;
      }
      if ((Dafny.Map<BigInteger, BigInteger>.Select(this.payments,parcelId)) <= (balance)) {
        (this).payments = Dafny.Map<BigInteger, BigInteger>.Update(this.payments, parcelId, BigInteger.Zero);
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Оплата успішна\n")).ToVerbatimString(false));
        paid = true;
        return paid;
      } else {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Недостатньо коштів\n")).ToVerbatimString(false));
        paid = false;
        return paid;
      }
      return paid;
